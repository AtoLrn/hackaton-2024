...
export default function Layout ()  {
    return <main className="w-full min-h-screen flex bg-[#f9faff]">
    <nav className="h-screen w-80 flex flex-col justify-between items-stretch gap-12 bg-white">
      ...
      <ul className="flex-1 flex flex-col p-4 gap-2">
        <li>
          <NavLink to={'/patients'} className="flex duration-200 items-center gap-4 px-4 py-3 rounded-xl aria-[current]:bg-[#fb4f14] bg-slate-200 text-black aria-[current]:text-white font-bold">
            <span>
              Patients
            </span>
          </NavLink>
        ...
        <li>
          <NavLink to={'/feedbacks'} className="flex duration-200 items-center gap-4 px-4 py-3 rounded-xl aria-[current]:bg-[#fb4f14] bg-slate-200 text-black aria-[current]:text-white font-bold">
            <span>
              Feedbacks
            </span>
          </NavLink>
